      ...
      <div className="Section-Inner">
        <div className="Testimonial">
          ...
          <p className="Testimonial-Content">
            ...
            learned how to apply technology in practice. Frontend education was
            demanding, it required a lot of time. Upon completion, I got my
            first job as a developer.
            <span className="Testimonial-Guotation">"</span>
          </p>
        </div>
      </div>
    </section>
